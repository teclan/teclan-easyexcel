...
public class CusPhoneListener extends AnalysisEventListener<CusPhone> {
	private static final Logger LOGGER = LoggerFactory.getLogger(CusPhoneListener.class);
	private static final int BATCH_COUNT = 1000;
	List<CusPhone> list = new ArrayList<CusPhone>();

	private Handler handler;

	private boolean headerVaild=true;;
	
	public CusPhoneListener(Handler handelr) {
	...
	public void invoke(CusPhone data, AnalysisContext context) {
